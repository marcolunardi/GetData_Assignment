...
geb = """Gödel, Escher, Bach: An Eternal Golden Braid, also known as GEB, is
a 1979 book by Douglas Hofstadter. The tagline "a metaphorical fugue
on minds and machines in the spirit of Lewis Carroll" was used by the
publisher to describe the book.
...
common = tokenize(mmg) & tokenize(geb)
common_long = [word for word in common if 5 <= len(word)]
print common_long
